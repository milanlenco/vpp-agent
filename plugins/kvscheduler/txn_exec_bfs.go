...
// executeTransactionBFS executes pre-processed transaction.
...
func (s *Scheduler) executeTransactionBFS(txn *transaction, graphW graph.RWAccess, dryRun bool) (executed kvs.RecordedTxnOps) {
